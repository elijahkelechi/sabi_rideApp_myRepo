  ...
  return (
    ...
    <View style={{borderBottomWidth: 2, borderColor: '#99989855', paddingBottom: 10 }}> 
      <View style={[styles.one, {marginTop: 15}]}>
          ...
          <Text style={styles.price}>NGN 3,100</Text>

        </View>

        <View style={styles.one}>
            <Text style={styles.startText}>Start</Text>
            <Text style={styles.time}>1hr 30m</Text>
    ...
    <View style={{borderBottomWidth: 2, borderColor: '#99989855', paddingBottom: 10 }}> 
      ...
      <View style={[styles.one, {marginTop: 15}]}>
          ...
          <Text style={styles.start}>Malali, Kb  </Text>
          <Text style={[styles.start, {marginHorizontal: -20}]}>{'------>'}</Text>
          <Text style={styles.destination}>Kid Park, Tard</Text>
          <Text style={styles.price}>NGN 1,100</Text>

        </View>

        <View style={styles.one}>
            <Text style={styles.startText}>Start</Text>
            <Text style={styles.time}>1hr 50m</Text>
            <Text style={styles.destText}>Destination</Text>
            <Text style={styles.date}>04 January at 02:23p.m.</Text>
        </View>
    ...
    <View style={{borderBottomWidth: 2, borderColor: '#99989855', paddingBottom: 10 }}> 
      ...
      <View style={[styles.one, {marginTop: 15}]}>
          ...
          <Text style={styles.price}>NGN 5,100</Text>

        </View>

        <View style={styles.one}>
            <Text style={styles.startText}>Start</Text>
            <Text style={styles.time}>2hr 30m</Text>
            <Text style={styles.destText}>Destination</Text>
